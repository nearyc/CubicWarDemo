...
namespace Nearyc.Skill
{
    ...
    public abstract class NeSkill : ISkill
    {
        ...
        public bool CanUse => _cooldown.CurrentValue >= _cooldown.Max;
        public System.Action onSkillStart { get; set; }
        public NeSkill(Component addToDispose, ESkillTag type = ESkillTag.None, float cooldown = 0)
        {
        ...
        public virtual void TryExecuteSKill(bool condition)
        {
            ...
            if (_isTryExecute && _cooldown.CurrentValue >= _cooldown.Max)
            {
                _isTryExecute = false;
